...
\begin{frame}
  ...
  \begin{block}{Preliminary conclusions}
    ...
    Occupancy has largest effect. Non-zero effect of other traits.
  \end{block}
\end{frame}
...
\begin{frame}
  \frametitle{Identifiability and ridges}
  \begin{center}
    \includegraphics[height = 0.8\textheight, width = \textwidth, keepaspectratio = true]{figure/wei_ridge}
  \end{center}
\end{frame}
